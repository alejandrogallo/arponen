((:PERMUTATIONS ("- 1.0") :TENSORS (("v" P4 P3 H1 H2)))
 (:PERMUTATIONS ("- 1.0" ("+ 1.0" (:PERMUTE (P3 P4 H1 H2) (P3 P4 H2 H1)))) :TENSORS
  (("Sum" H5) ("f" H5 H1) ("t" P3 P4 H5 H2)))
 (:PERMUTATIONS ("+ 1.0" ("- 1.0" (:PERMUTE (P4 P3 H2 H1) (P3 P4 H2 H1)))) :TENSORS
  (("Sum" P5) ("f" P4 P5) ("t" P5 P3 H2 H1)))
 ...
 (:PERMUTATIONS ("+ 0.5") :TENSORS (("Sum" P5 P6) ("t" P5 P6 H2 H1) ("v" P4 P3 P5 P6)))
 (:PERMUTATIONS ("- 0.5" ("+ 0.5" (:PERMUTE (P4 P3 H2 H1) (P3 P4 H2 H1)))) :TENSORS
  (("Sum" H7 H8 P5 P6) ("t" P5 P4 H2 H1) ("t" P6 P3 H7 H8) ("v" H7 H8 P5 P6)))
 (:PERMUTATIONS ("- 0.25") :TENSORS
  (("Sum" H7 H8 P5 P6) ("t" P5 P6 H2 H1) ("t" P3 P4 H7 H8) ("v" H7 H8 P5 P6)))
