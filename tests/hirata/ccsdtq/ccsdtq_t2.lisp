((:PERMUTATIONS ("+ 1.0") :TENSORS (("v" P3 P4 H1 H2)))
 ...
 (:PERMUTATIONS ("+ 0.25") :TENSORS
  (("Sum" H7 H8 P5 P6) ("t" P5 P6 P3 P4 H7 H8 H1 H2) ("v" H7 H8 P5 P6)))
 ...
 (:PERMUTATIONS ("- 0.5" ("+ 0.5" (:PERMUTE (P3 P4 H2 H1) (P3 P4 H1 H2)))) :TENSORS
  (("Sum" H6 H7 P5 P8) ("t" P5 P3 P4 H6 H7 H2) ("t" P8 H1) ("v" H6 H7 P5 P8)))
 (:PERMUTATIONS ("+ 0.5" ("- 0.5" (:PERMUTE (P3 P4 H1 H2) (P4 P3 H1 H2)))) :TENSORS
  (("Sum" H7 H8 P5 P6) ("t" P5 P6 P3 H7 H1 H2) ("t" P4 H8) ("v" H7 H8 P5 P6)))
 (:PERMUTATIONS ("+ 1.0") :TENSORS
  (("Sum" H6 H8 P5 P7) ("t" P5 P3 P4 H6 H1 H2) ("t" P7 H8) ("v" H6 H8 P5 P7)))
